...
HD_PWD='C:/Users/jayna/Desktop/MurmurHash3-Accelerator/murmurhash3-BoardDemo/murmurhash3-BoardDemo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_top_board_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_top_board_demo.tcl -notrace
